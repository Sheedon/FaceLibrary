...
public class FaceRoundView extends View {
    ...
    public static final int PATH_SPACE = 230;
    ...
    public static final int COLOR_RECT = Color.parseColor("#FFFFFF");
    public static final int COLOR_ROUND = Color.parseColor("#1B95FF");
...
//            Log.e(TAG, mFaceRect.toString());
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        r = canvasWidth < canvasHeight ? (canvasWidth / 2) : (canvasHeight / 2);
