...
public class FaceDetectManager {
    ...
    public void check(int[] argb, int width, int height, ArgbPool pool) {
        if (processHandler != null) {
            localProcessRunnable.setProcess(argb, width, height, pool);
            processHandler.post(localProcessRunnable);
        }
    }

    private ProcessRunnable localProcessRunnable = new ProcessRunnable();
    ...
    public class ProcessRunnable implements Runnable {
        ...
        void setProcess(int[] argb, int width, int height, ArgbPool pool) {
            this.argb = argb;
            this.width = width;
            this.height = height;
            this.pool = pool;
    ...
    public void process(int[] argb, int width, int height, ArgbPool pool) {
        int value;

        ImageFrame frame = new ImageFrame();//imageSource.borrowImageFrame();
        frame.setArgb(argb);
