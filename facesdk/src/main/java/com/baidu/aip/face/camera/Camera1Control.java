...
public class Camera1Control implements ICameraControl, TextureView.SurfaceTextureListener {
...
//                    Log.e("onPreviewFrame", "onPreviewFrame");
                    ...
                    if (rotation % 180 == 90 || rotation % 180 == 0) {
...
//            camera.setDisplayOrientation(getSurfaceOrientation());
    ...
    private Camera.Size lastSize = null;
